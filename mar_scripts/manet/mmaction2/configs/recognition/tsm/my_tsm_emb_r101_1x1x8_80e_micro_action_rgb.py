_base_ = [
    '../../_base_/models/my_tsm_r101.py', '../../_base_/schedules/my_sgd_tsm_80e.py',
...
data_root_val = '/chenguoliang/data/micro_action/fined_videos/test/'
ann_file_train = '/chenguoliang/data/micro_action/new_annotation/new_train.txt'
ann_file_val = '/chenguoliang/data/micro_action/new_annotation/new_test.txt'
ann_file_test = '/chenguoliang/data/micro_action/new_annotation/new_test.txt'
...
work_dir = '/chenguoliang/code/mmaction2/work_dirs/my_tsm_emb_r101_1x1x8_80e_micro_action_rgb/'
